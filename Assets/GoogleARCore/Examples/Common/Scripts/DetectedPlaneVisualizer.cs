...
namespace GoogleARCore.Examples.Common
{
    ...
    public class DetectedPlaneVisualizer : MonoBehaviour
    {
        ...
        public void Awake()
        {
            ...
            if (GetComponent<UnityEngine.MeshRenderer>() != null)
            {
                m_MeshRenderer = GetComponent<UnityEngine.MeshRenderer>();
            }

            helloARController = GameObject.Find("Example Controller").GetComponent<HelloARController>();
        ...
        public void Update()
        {
            ...
            if (!helloARController.GetComponent<HelloARController>().doRotate)
            {
